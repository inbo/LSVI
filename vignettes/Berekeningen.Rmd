...
Bij voorwaarden met deze analysevariabele worden de soorten/kenmerken geselecteerd op basis van een functie `deselecteerKenmerkenInOpname()`, die in de opname van de gebruiker de soorten/kenmerken schrapt die in de taxonlijst/studielijst voorkomen (en de overblijvende soorten/kenmerken vormen de selectie).
...
- in de eerste plaats wordt geprobeerd om de gevonden Gbif-key te koppelen met de taxonlijst uit het package om de accepted key en de hogere taxonniveaus over te nemen
- als dit niet lukt, zal ook de accepted key via Gbif opgezocht worden en zal geprobeerd worden om deze te koppelen met de taxonlijst uit het package om de hogere taxonniveaus over te nemen
