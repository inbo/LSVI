...
Bij voorwaarden met deze analysevariabele worden de soorten/kenmerken geselecteerd op basis van een functie `deselecteerKenmerkenInOpname()`, die in de opname van de gebruiker de soorten/kenmerken schrapt die in de taxonlijst/studielijst voorkomen.  Verder gebeurt de berekening analoog aan deze van de analysevariabele [`bedekking`](#bedekking)
...
Bij voorwaarden met deze analysevariabele worden de soorten/kenmerken geselecteerd op basis van een functie `deselecteerKenmerkenInOpname()`, die in de opname van de gebruiker de soorten/kenmerken schrapt die in de taxonlijst/studielijst voorkomen.  Verder gebeurt de berekening analoog aan deze van de analysevariabele [`maxBedekking`](#maxBedekking).
