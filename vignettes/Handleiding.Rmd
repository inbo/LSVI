...
Dit is de map waarin je aan 't werken bent.
Je kan deze working directory zelf bepalen door het commando `setwd("C:/.../mijn_werkmap")`.
Als je in een project werkt waarin je al je scripts opslaat (aan te raden), dan is de root van dit project automatisch je working directory.
