...
- andere (selecteerXXX, vertaalXXX en connecteerXXX): hulpfuncties die eventueel relevant kunnen zijn voor gevorderde R-gebruikers (zie 'Gebruik van bouwstenen')
