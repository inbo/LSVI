...
.onLoad <- function(libname, pkgname) {
  tryCatch(
    ...
    error = function(e) {
      print("Er kan geen connectie gelegd worden met de databank.  Voorzie bij elke functie zelf een link naar een databank met indicatoren voor elk habitattype.")
    }
  )
