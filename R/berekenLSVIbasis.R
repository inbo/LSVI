...
#' overgenomen worden bij de uitvoer. Indien de parameter Oppervlakte_opname op
#' TRUE wordt gezet, moet een extra veld Opp_m2 worden toegevoegd met de
#' oppervlakte van de opname (proefvlak of perceel) in m2.
