...
geefInfoHabitatfiche <- 
  function(ConnectieLSVIhabitats,
    ...
    Indicator_bIDs <- paste(unique(Selectiegegevens$Indicator_beoordelingID), collapse = ",")
    ...
    Habitatfiche <- Selectiegegevens %>%
      ...
      select_(~Habitattype, ~Habitatnaam, ~Habitatsubtype, ~Habitatsubtypenaam,
              ~HabitatsubtypeOmschrijving, ~Criterium.habitat, ~Indicator.habitat,
              ~Beschrijving, ~Maatregelen, ~Opmerkingen.habitat,
              ~Referenties.habitat, ~Soortenlijst,
