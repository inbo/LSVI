...
#bij het veralgemenen van deze functie moet deze left_join herhaald worden volgens het maximale aantal niveaus vermeld in Indicator_habitat$NiveauSoortenlijstFiche (of tot SoortensubgroepID NA is?)
...
#ook dit moet verder uitgebreid worden bij het veralgemenen van de functie, evt. door alle SoortID's te selecteren en de niet-NA eruit te kiezen?
