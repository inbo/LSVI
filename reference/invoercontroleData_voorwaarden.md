...
voorkomen, aangeroepen wordt). Ingeval van Data_voorwaarden is ook de
omzetting van de voorwaarden naar een interval opgenomen in de functie.

## Usage

``` r
invoercontroleData_voorwaarden(Data_voorwaarden, ConnectieLSVIhabitats, LIJST)
```
